    ...
    <div ref={searchRef} className="relative w-full max-w-xl">
      <form onSubmit={handleSearch} className="relative">
        <input
          ...
          className="w-full px-4 py-2 rounded-full border border-[#000000] focus:outline-none focus:ring-2 focus:ring-[#000000]/50 bg-white placeholder-gray-400"
        />
        <button
          type="submit"
          className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#000000] hover:text-[#B4941F] transition-colors"
        >
          <Search size={20} />
        </button>
      </form>
